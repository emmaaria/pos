                    ...
                    <table style={{width: '100%', display: 'block'}}>
                        ...
                        <tr style={{width: '100%', display: 'block', textAlign: 'center', borderBottom: 'none'}}>
                            <td style={{textAlign: 'center', display: 'inline-block'}}>
                                <button style={{background: '#e84118', border: 'none', color: '#ffffff', fontSize: '15px', padding: '5px 12px', borderRadius: '5px', marginRight: '10px'}} onClick={closeInvoice}>Close</button>
                            </td>
                            <td style={{textAlign: 'center', display: 'inline-block'}}>
                                <button style={{background: '#009432', border: 'none', color: '#ffffff', fontSize: '15px', padding: '5px 12px', borderRadius: '5px', marginRight: '10px'}}>Print</button>
                            </td>
                        </tr>
                        </tfoot>
                    </table>
