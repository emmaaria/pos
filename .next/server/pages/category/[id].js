...
/* harmony import */ var _models_Category__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(351);
...
function EditCategory({ user , category  }) {
    const handleForm = async (e)=>{
        ...
        try {
            const res = await axios__WEBPACK_IMPORTED_MODULE_6___default().post("/api/category/update", {
                name,
                id: category._id
            });
            if (res.status === 201) {
...
const getServerSideProps = (0,iron_session_next__WEBPACK_IMPORTED_MODULE_3__/* .withIronSessionSsr */ .c)(async function getServerSideProps({ req , params  }) {
    ...
    const categoryObject = await _models_Category__WEBPACK_IMPORTED_MODULE_9__/* ["default"].findById */ .Z.findById({
        _id: categoryId
    }).lean();
...
var __webpack_exports__ = __webpack_require__.X(0, [5895,9531,3061,5126,780], () => (__webpack_exec__(4258)));
