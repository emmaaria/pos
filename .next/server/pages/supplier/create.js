...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ CreateSupplier),
...
/* harmony import */ var _components_Loader__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(9270);
...
function CreateSupplier({ user  }) {
    ...
    const handleForm = async (e)=>{
        ...
        try {
            const res = await axios__WEBPACK_IMPORTED_MODULE_6___default().post(`${"http://pos-backend.webxcode.xyz/api"}/supplier/store`, {
                name,
                mobile,
                address,
                due
            ...
            if (res.data.status === true) {
                ...
                react_toastify__WEBPACK_IMPORTED_MODULE_5__.toast.dismiss();
                react_toastify__WEBPACK_IMPORTED_MODULE_5__.toast.success("Something went wrong", {
                    position: "bottom-right",
                    autoClose: 5000,
                    hideProgressBar: false,
                    closeOnClick: true,
            ...
            react_toastify__WEBPACK_IMPORTED_MODULE_5__.toast.dismiss();
            react_toastify__WEBPACK_IMPORTED_MODULE_5__.toast.error(e1.response.statusText, {
                position: "bottom-right",
                autoClose: 3000,
                hideProgressBar: false,
                closeOnClick: true,
                                ...
                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("label", {
                                            htmlFor: "mobile",
                                            className: `form-label`,
                                            children: "Supplier Mobile Number"
                                        }),
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("input", {
                                            type: "text",
...
var __webpack_exports__ = __webpack_require__.X(0, [895,531,61,220], () => (__webpack_exec__(3456)));
