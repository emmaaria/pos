...
function CreateUnit({ user  }) {
    const handleForm = async (e)=>{
        ...
        try {
            const res = await axios__WEBPACK_IMPORTED_MODULE_6___default().post("/api/unit/create", {
                name
            });
            if (res.status === 201) {
...
var __webpack_exports__ = __webpack_require__.X(0, [5895,9531,3061,5126], () => (__webpack_exec__(5331)));
