...
/* harmony import */ var _models_Unit__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(5853);
...
function EditUnit({ user , unit  }) {
    const handleForm = async (e)=>{
        ...
        try {
            const res = await axios__WEBPACK_IMPORTED_MODULE_6___default().post("/api/unit/update", {
                name,
                id: unit._id
            });
            if (res.status === 201) {
...
const getServerSideProps = (0,iron_session_next__WEBPACK_IMPORTED_MODULE_3__/* .withIronSessionSsr */ .c)(async function getServerSideProps({ req , params  }) {
    ...
    const unitObject = await _models_Unit__WEBPACK_IMPORTED_MODULE_9__/* ["default"].findById */ .Z.findById({
        _id: unitId
    }).lean();
...
var __webpack_exports__ = __webpack_require__.X(0, [5895,9531,3061,5126], () => (__webpack_exec__(9506)));
