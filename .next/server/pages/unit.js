...
function Unit({ user  }) {
    ...
    async function getUnits() {
        try {
            const res = await axios__WEBPACK_IMPORTED_MODULE_7___default().post("/api/unit", {
                page: page1
            });
            if (res.status === 200) {
    ...
    const deleteHandler = async (id)=>{
        ...
        try {
            const response = await axios__WEBPACK_IMPORTED_MODULE_7___default().post("/api/unit/delete", {
                id: id
            });
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tbody", {
                                        children: [
                                            ...
                                            units && units.map((el, index)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", {
                                                    valign: `middle`,
                                                    children: [
...
var __webpack_exports__ = __webpack_require__.X(0, [5895,9531,3061,5126,4689], () => (__webpack_exec__(8891)));
