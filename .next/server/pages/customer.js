...
function Customer({ user  }) {
    const { 0: customers , 1: setCustomers  } = (0,react__WEBPACK_IMPORTED_MODULE_6__.useState)();
    ...
    async function getCustomers() {
        try {
            const res = await axios__WEBPACK_IMPORTED_MODULE_7___default().post("/api/customer", {
                page: page1
            });
            if (res.status === 200) {
    ...
    const deleteHandler = async (id)=>{
        ...
        try {
            const response = await axios__WEBPACK_IMPORTED_MODULE_7___default().post("/api/customer/delete", {
                id: id
            });
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("table", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tbody", {
                                        children: [
                                            customers && customers.length <= 0 && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("tr", {
                                            ...
                                            customers && customers.map((el, index)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", {
                                                    valign: `middle`,
                                                    children: [
...
var __webpack_exports__ = __webpack_require__.X(0, [5895,9531,3061,5126,4689], () => (__webpack_exec__(6996)));
