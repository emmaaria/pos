...
function Supplier({ user  }) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_6__.useEffect)(()=>{
        axios__WEBPACK_IMPORTED_MODULE_7___default().get(`${"http://pos-backend.webxcode.xyz/api"}/supplier`, headers).then((res)=>{
    ...
    const searchSupplier = async ()=>{
        ...
        setTimer(setTimeout(()=>{
            ...
            axios__WEBPACK_IMPORTED_MODULE_7___default().get(`${"http://pos-backend.webxcode.xyz/api"}/supplier?name=${name}`, headers).then((res)=>{
                if (res.data.status === true) {
                    setSuppliers(res.data.suppliers.data);
                    setLinks(res.data.suppliers.links);
                    setLoading(false);
    ...
    const deleteHandler = async (id)=>{
        ...
        try {
            const response = await axios__WEBPACK_IMPORTED_MODULE_7___default().post(`${"http://pos-backend.webxcode.xyz/api"}/supplier/delete`, {
                id: id
            }, headers);
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tbody", {
                                        children: [
                                            ...
                                            suppliers && !loading && suppliers.map((el, index)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", {
                                                    valign: `middle`,
...
var __webpack_exports__ = __webpack_require__.X(0, [895,531,61,220,689], () => (__webpack_exec__(7145)));
