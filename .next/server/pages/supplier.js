...
function Supplier({ user  }) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_6__.useEffect)(()=>{
        axios__WEBPACK_IMPORTED_MODULE_7___default().get(`${"//pos-backend.webxcode.xyz/api"}/supplier`, headers).then((res)=>{
    ...
    const searchSupplier = async ()=>{
        ...
        setTimer(setTimeout(()=>{
            ...
            axios__WEBPACK_IMPORTED_MODULE_7___default().get(`${"//pos-backend.webxcode.xyz/api"}/supplier?name=${name}`, headers).then((res)=>{
                if (res.data.status === true) {
                    setSuppliers(res.data.suppliers.data);
                    setLinks(res.data.suppliers.links);
                    setLoading(false);
    ...
    const deleteHandler = async (id)=>{
        ...
        try {
            const response = await axios__WEBPACK_IMPORTED_MODULE_7___default().post(`${"//pos-backend.webxcode.xyz/api"}/supplier/delete`, {
                id: id
            }, headers);
