...
function CreateProduct({ user  }) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_8__.useEffect)(()=>{
        async function getData() {
            try {
                const res = await axios__WEBPACK_IMPORTED_MODULE_6___default().post("/api/category", {
                    all: true
                });
                if (res.status === 200) {
            ...
            try {
                const res = await axios__WEBPACK_IMPORTED_MODULE_6___default().post("/api/unit", {
                    all: true
                });
                if (res.status === 200) {
    ...
    const handleForm = async (e)=>{
        ...
        try {
            const res = await axios__WEBPACK_IMPORTED_MODULE_6___default().post("/api/product/create", {
                name,
                category,
                defaultUnit,
                secondaryUnit,
...
var __webpack_exports__ = __webpack_require__.X(0, [5895,9531,3061,5126], () => (__webpack_exec__(257)));
