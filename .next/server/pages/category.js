...
function Category({ user  }) {
    const { 0: categories , 1: setCategories  } = (0,react__WEBPACK_IMPORTED_MODULE_6__.useState)();
    ...
    async function getCategories() {
        try {
            const res = await axios__WEBPACK_IMPORTED_MODULE_7___default().post("/api/category", {
                page: page1
            });
            if (res.status === 200) {
    ...
    const deleteHandler = async (id)=>{
        ...
        try {
            const response = await axios__WEBPACK_IMPORTED_MODULE_7___default().post("/api/category/delete", {
                id: id
            });
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("table", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tbody", {
                                        children: [
                                            categories && categories.length <= 0 && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("tr", {
                                            ...
                                            categories && categories.map((el, index)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", {
                                                    valign: `middle`,
                                                    children: [
...
var __webpack_exports__ = __webpack_require__.X(0, [5895,9531,3061,5126,4689], () => (__webpack_exec__(4055)));
