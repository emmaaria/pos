...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,iron_session_next__WEBPACK_IMPORTED_MODULE_2__/* .withIronSessionApiRoute */ .n)(async (req, res)=>{
    if (req.session.user) {
        ...
        const product = await _models_Product__WEBPACK_IMPORTED_MODULE_3__/* ["default"].findByIdAndDelete */ .Z.findByIdAndDelete(id);
        if (product) {
            res.status(201).send({
                success: "Deleted"
            });
...
var __webpack_exports__ = __webpack_require__.X(0, [8534,2606], () => (__webpack_exec__(8153)));
