...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,iron_session_next__WEBPACK_IMPORTED_MODULE_2__/* .withIronSessionApiRoute */ .n)(async (req, res)=>{
    if (req.session.user) {
        ...
        if (due === "") {
            const supplier = new _models_Supplier__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z({
                name,
                mobile,
                address
            });
...
var __webpack_exports__ = __webpack_require__.X(0, [8534,5351], () => (__webpack_exec__(2309)));
