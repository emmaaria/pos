...
function Product({ user  }) {
    ...
    const { 0: products , 1: setProducts  } = (0,react__WEBPACK_IMPORTED_MODULE_6__.useState)();
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_6__.useEffect)(()=>{
        axios__WEBPACK_IMPORTED_MODULE_7___default().get(`${"http://pos-backend.webxcode.xyz/api"}/product`, headers).then((res)=>{
    ...
    const searchProduct = async ()=>{
        ...
        setTimer(setTimeout(()=>{
            ...
            axios__WEBPACK_IMPORTED_MODULE_7___default().get(`${"http://pos-backend.webxcode.xyz/api"}/product?name=${name}`, headers).then((res)=>{
                if (res.data.status === true) {
                    setProducts(res.data.products.data);
                    setLinks(res.data.products.links);
                    setLoading(false);
    ...
    const deleteHandler = async (id)=>{
        ...
        try {
            const response = await axios__WEBPACK_IMPORTED_MODULE_7___default().post(`${"http://pos-backend.webxcode.xyz/api"}/product/delete`, {
                id: id
            }, headers);
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("table", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tbody", {
                                        children: [
                                            products && products.length <= 0 && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("tr", {
                                            ...
                                            products && !loading && products.map((el, index)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", {
                                                    valign: `middle`,
...
var __webpack_exports__ = __webpack_require__.X(0, [895,531,61,220,689], () => (__webpack_exec__(9088)));
