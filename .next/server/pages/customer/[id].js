...
const CustomerModel = (mongoose__WEBPACK_IMPORTED_MODULE_0___default().models.Customer) || mongoose__WEBPACK_IMPORTED_MODULE_0___default().model("Customer", schema);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CustomerModel);
...
/* harmony import */ var _models_Customer__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(9309);
...
function EditCustomer({ user , customer  }) {
    const handleForm = async (e)=>{
        ...
        try {
            const res = await axios__WEBPACK_IMPORTED_MODULE_6___default().post("/api/customer/update", {
                name,
                mobile,
                address,
                id: customer._id
...
const getServerSideProps = (0,iron_session_next__WEBPACK_IMPORTED_MODULE_3__/* .withIronSessionSsr */ .c)(async function getServerSideProps({ req , params  }) {
    ...
    const customerObject = await _models_Customer__WEBPACK_IMPORTED_MODULE_9__/* ["default"].findById */ .Z.findById({
        _id: customerId
    }).lean();
...
var __webpack_exports__ = __webpack_require__.X(0, [5895,9531,3061,5126], () => (__webpack_exec__(4878)));
