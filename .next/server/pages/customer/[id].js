...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ EditCustomer),
...
/* harmony import */ var react_loading_skeleton__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(9012);
...
function EditCustomer({ user , id  }) {
    const { 0: customer , 1: setCustomer  } = (0,react__WEBPACK_IMPORTED_MODULE_8__.useState)();
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_8__.useEffect)(()=>{
        axios__WEBPACK_IMPORTED_MODULE_6___default().get(`${"http://pos-backend.webxcode.xyz/api"}/customer/${id}`, headers).then((res)=>{
    ...
    const handleForm = async (e)=>{
        ...
        try {
            const res = await axios__WEBPACK_IMPORTED_MODULE_6___default().post(`${"http://pos-backend.webxcode.xyz/api"}/customer/update`, {
                name,
                mobile,
                address,
                id: id
            ...
            if (res.data.status === true) {
                ...
                react_toastify__WEBPACK_IMPORTED_MODULE_5__.toast.dismiss();
                react_toastify__WEBPACK_IMPORTED_MODULE_5__.toast.error(e.response.data.errors, {
                    position: "bottom-right",
                    autoClose: 3000,
                    hideProgressBar: false,
                    closeOnClick: true,
                            ...
                            children: [
                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                    ...
                                    children: [
                                        ...
                                        customer && loading === false && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("input", {
                                            type: "text",
...
var __webpack_exports__ = __webpack_require__.X(0, [895,531,61,220], () => (__webpack_exec__(4878)));
