...
function CreateCustomer({ user  }) {
    ...
    const handleForm = async (e)=>{
        ...
        try {
            const res = await axios__WEBPACK_IMPORTED_MODULE_6___default().post(`${"http://pos-backend.webxcode.xyz/api"}/customer/store`, {
                name,
                mobile,
                address,
                due
...
var __webpack_exports__ = __webpack_require__.X(0, [895,531,61,220], () => (__webpack_exec__(5436)));
