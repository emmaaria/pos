...
function Login() {
    ...
    const handleForm = async (e)=>{
        ...
        try {
            const response = await axios__WEBPACK_IMPORTED_MODULE_3___default().post("/api/auth/login", {
                email,
                password
            });
...
var __webpack_exports__ = __webpack_require__.X(0, [9531], () => (__webpack_exec__(4369)));
