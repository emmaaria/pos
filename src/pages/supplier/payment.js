...
export default function SupplierPayment({user}) {
    const headers = {
    ...
    const handleForm = async (e) => {
        ...
        try {
            const res = await axios.post(`${process.env.API_URL}/supplier/payment/store`, {
                supplier,
                note,
                amount,
                account,
    ...
    return (
        <>
            ...
            <ToastContainer/>
            <Layout user={user} title={`Supplier Payment`}>
                <div className={`content ${mode === 'dark' ? 'dark-mode-bg-body' : 'body-bg'}`}>
                    <div className="custom-card">
                        <div className="mb-3 row">
                            ...
                            <div className="col-md-4">
                                <label htmlFor="note" className={`form-label`}>Paid By</label>
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-md-6">
                                <label htmlFor="note" className={`form-label`}>Payment Note</label>
