...
export default function SaleBySupplier({user}) {
    ...
    useEffect(() => {
        ...
        getData();
    }, [setCategories, setSuppliers, setProducts]);
    ...
    const search = (e) => {
        ...
        setLoading(true);
        axios.post(
            `${process.env.API_URL}/report/sales/by-supplier`, {
                supplier: supplier,
                product: product,
                category: category,
    ...
    return (
        <>
            ...
            <ToastContainer/>
            <Layout user={user} title={`Supplier Wise Sales`}>
