...
export default function CreateSupplierReturn({user}) {
    ...
    const handleForm = async (e) => {
        ...
        try {
            const res = await axios.post(`${process.env.API_URL}/return/supplier/store`, {
                productIds,
                productQuantities,
                productPrices,
                date,
    ...
    return (
        <>
            ...
            <ToastContainer/>
            <Layout user={user} title={`Add Supplier Return`}>
                    ...
                    <div className="custom-card">
                        <div className="mb-3">
                            <div className="row">
                                ...
                                <div className="col-md-3">
                                    <label htmlFor="date" className={`form-label`}>Supplier</label>
                                    <AutocompleteInput
                                        type='supplier'
                                        token={user.token}
