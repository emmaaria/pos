...
export default function CustomerDueList({user}) {
    const headers = {
    ...
    useEffect(() => {
        axios.post(
            `${process.env.API_URL}/customer/dues`, {},
            headers
        ).then(res => {
            if (res.data.status === true) {
    ...
    const deleteHandler = async (id) => {
        ...
        try {
            const response = await axios.post(`${process.env.API_URL}/customer/due/delete`, {
                id: id,
            }, headers);
    ...
    return (
        <>
            ...
            <ToastContainer/>
            <Layout user={user} title={`Manage Customer Manual Due`}>
                        ...
                        <div className="row mb-4">
                            <div className="col-md-12">
                                <Link href={`/customer/due`} className={`btn btn-success`}>
                                    <i className="fa-solid fa-plus"/> Add Customer Due
                                </Link>
                            </div>
                        </div>
                        <hr/>
